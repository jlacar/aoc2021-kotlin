 ...
 */
fun main() {
    fun naiveSolution(input: List<Int>, days: Int): Long {
    ...
    fun moreEfficientSolution(input: List<Int>, days: Int): Long {
        val timers = LongArray(9) { 0L }
        input.forEach { timers[it] += 1L }
        repeat(days) {
    ...
    fun part1(input: List<Int>): Long =
        moreEfficientSolution(input, 80)
//        naiveSolution(input)
